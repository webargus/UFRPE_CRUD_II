...
class PainelProfessores:
    ...
    def __init__(self, frame):
        ...
        self.nomeEdit = Entry(fProf).grid({"row": 0, "column": 1, "columnspan": 4, "sticky": (W, E)})
        Button(fProf, {"width": 30, "image": tools.StaticImages.arrow16}).grid({"row": 0, "column": 5})
        ...
        self.submitBtn = Button(fProf, {"text": "Ok", "width": 70, "image": tools.StaticImages.tick16, "compound": "left"}).grid({"row": 1, "column": 4, "padx": 4, "pady": 8, "sticky": E})
        self.delBtn = Button(fProf, {"text": "Excluir", "width": 70, "image": tools.StaticImages.del16, "compound": "left"}).grid({"row": 1, "column": 5, "pady": 8, "sticky": E})
